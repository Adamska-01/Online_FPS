...
public class InventoryWeaponMountInfo :  InventoryMountInfo
{
	...
	public Vector3 PickUpPosition { set; get; }

	public Quaternion PickUpRotation { set; get; }
}
...
public abstract class Inventory : ScriptableObject
{
	...
	public abstract CollectableItem				DropWeaponItem(int _mountIndex, bool _playAudio = true);
